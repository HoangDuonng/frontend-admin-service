import FooterConfigClient from '../../../components/client-config/FooterConfigClient';
    ...
    return (
        <div className="p-8">
            ...
            <p className="mb-8 text-gray-500 text-center max-w-2xl mx-auto leading-relaxed text-lg">
                Quản lý các footer sẽ hiển thị trên trang web client.<br />
                Bạn có thể thêm, sửa, xóa hoặc sắp xếp các footer tại đây.
            </p>
            <FooterConfigClient />
        </div>
    );
